...
export const AnimatedShaderHero: React.FC<HeroProps> = ({
  ...
  return (
    <section className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white bg-black/40 backdrop-blur-[2px]">
        {/* Trust Badge */}
        {trustBadge && (
          <div className="mb-8">
            <div className="flex items-center gap-2 px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-sm">
              ...
              <span className="text-white/90 font-medium tracking-wide">{trustBadge.text}</span>
            </div>
          </div>
        )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              ...
              {buttons.secondary && (
                <a 
                  ...
                  className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-full font-semibold text-lg transition-all duration-300 backdrop-blur-sm inline-block"
                >
...
void main(void) {
	...
	for (float i=1.; i<12.; i++) {
		...
		col=mix(col,vec3(bg*.15,bg*.05,bg*.2),d); // modified to purplish tone
	}
	O=vec4(col,1);
}`;
